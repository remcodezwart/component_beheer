...
Voor dhr. Molengraaf hebben wij tijdens onze studie een oplossing gerealiseerd voor het probleem: "moeite bij het bijhouden van voorraden". Dit hebben wij gedaan door in HUGE een voorraadsysteem te maken waarbij je componenten kan toevoegen, verwijderen, veranderen en opzoeken. Dit systeem kan gebruikt worden door op het zoek icoon te klikken en vervolgens:
* Met de barcodescanner een product scannen, en vervolgens dit product in te nemen, uit te lenen of de voorraad aanpassen
* Met de barcodescanner een leerlingenpas scannen en vervolgens de artikelen die de leerling in zijn bezit heeft administratief in te nemen.

Dit allen kan ook handmatig gedaan worden zonder barcodescanner.

## Gebouwd met:

* [HUGE](https://github.com/panique/huge) - Back-end framework
